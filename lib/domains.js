...
var permanently_blocked = {
	...
	//17.05.2019
	'animeteatr.tv':1, 'shikimori.org':1, 'animespirit.ru':1, 'animevost.in':1, 'adultmult.tv':1, 'yandere.tv':1,
}
...
const bad_domains = {
	...
	//nnm-club
	'nt-club.gq':1, 'ww1.nnm-club.tv':1, 'nnm-club.tv':1,
};
const bad_domain_whitelist = {
	...
	'nnmclub.to':1, 'nnm-club.lib':1, 'nnm-club.me':1, 'ipv6.nnm-club.name':1, 'ipv6.nnm-club.me':1, 'nnmclub5toro7u65.onion':1,
	'ipv6.nnm-club.lib':1, 'nnm-club.ws':1, 
}
const official_domain = {
	'rutracker.org':1, 'nnm-club.me':1,
}
